...
<% 
	...
	List<CommodityCategory> categoryList = (List<CommodityCategory>)request.getAttribute("categoryList");
%>
...
<div class="manage_right">
	<div class="content">
		...
		<div class="manageButton">
			<a class="button" href="<%=basePath %>/commodity/beforeAdd">新增</a>
		</div>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<% if(list.get(i).getCategoryId() == categoryList.get(j).getId()){%>
							<%=categoryList.get(j).getName() %>
						<%}%>	
						<% } %>
						</td>
